...
export const Player = (state = { 
    ...
    switch(action.type) {
        case ActionTypes.ADD_MAP:
            return({...state, name: action.payload.player.name, skin: action.payload.player.skin, position:action.payload.player.position, direction: DOWN, spriteLocation: SPRITE_LOC_DOWN});
