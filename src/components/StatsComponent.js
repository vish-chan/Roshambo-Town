            ...
            <div id="stats" style={style}>
                ...
                <div style={{width:'10%', display:'flex', alignItems: 'center'}}>
                    <button disabled={(this.props.player.isAnimating || this.props.player.frozen || this.props.player.inBattle || this.props.player.interacting)} 
                            style={{margin:'5px', ...bgStyle('DarkTurquoise'), fontFamily:'gameboy', color:'white'}} onClick={this.handleSaveBtnClick}><i className="fa fa-save fa-2x" style={{margin:'5px'}}/> Save
                    </button>
                </div>
            </div>
        );
